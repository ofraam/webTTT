...
def logFinalData():
    ...
    xkv = XKeyValueFinal(userid=userid, expCondition=expCondition, boardSize=boardSize,board=board,solvedCorrect=solvedCorrect,validatedCorrect=validatedCorrect, numActionsSolve=numActionsSolve,numActionsValidate=numActionsValidate, timeSolution=timeSolution, timeValidation=timeValidate, clientTime=clientTime)
